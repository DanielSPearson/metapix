import { uploadImage } from './../../scripts/imageUpload.js';
...
describe('Image Upload', () => {
  ...
  beforeEach(() => {
    ...
    global.FileReader = jest.fn(() => {
      ...
      setTimeout(() => {
        reader.onload(new ProgressEvent('load', { loaded: 100, total: 100 }));
      }, 0);

      return {
        ...reader,
        readAsDataURL: jest.fn(() => {
          reader.result = `data:image/png;base64,${base64Image}`;
        }),
      };
    });
